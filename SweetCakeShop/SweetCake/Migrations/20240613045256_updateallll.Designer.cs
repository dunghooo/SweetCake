...
namespace SweetCake.Migrations
{
    ...
    [Migration("20240613045256_updateallll")]
    partial class updateallll
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SweetCake.Data.ThongKeDoanhThu", b =>
                {
            ...
            modelBuilder.Entity("SweetCake.Data.ThongKeDoanhThuTheoNgay", b =>
                {
                    b.Property<int>("DoanhThu")
                        .HasColumnType("int");
                    ...
                    b.ToTable("ThongKeDoanhThuTheoNgay");
                });
            ...
            modelBuilder.Entity("SweetCake.Models.ThongTin_NhanHang", b =>
                {
                    b.HasOne("SweetCake.Models.DonHang", null)
                        .WithOne("ThongTin_NhanHang")
                        .HasForeignKey("SweetCake.Models.ThongTin_NhanHang", "DonhangId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
